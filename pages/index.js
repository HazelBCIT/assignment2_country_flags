  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Country flags of the world" />
      ...
      <main className={styles.main}>
        ...
        <Title
          title_img="/world.jpg" 
          page_title="Countries All Over The World" 
          button_title="View By Region"
        />
        <div className={styles.container}>
        {
          countries.map((f_data, index) => {
            return (
                ...
                <div className={styles.box} id="box" key={index}>
