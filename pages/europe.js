...
export default function Europe() {
  ...
  return (
    <>
      <Head>
        <title>World Flags - Europe</title>
        <meta name="description" content="Country flags of Europe Region" />
      ...
      <main className={styles.main}>
        <Header />
        <Title
          title_img="/europe@2x.png" 
          page_title="Europe Region" 
          ...
          {countries.map((f_data, index) => {
            return (
              <>
                <>
                {
                  f_data.region == "Europe" ? <div className={styles.box} id="box" key={index}>
