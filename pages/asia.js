...
export default function Asia() {
  ...
  return (
    <>
      <Head>
        <title>World Flags - Asia</title>
        <meta name="description" content="Country flags of Asia Region" />
      ...
      <main className={styles.main}>
        <Header />
        <Title
          title_img="/asia@2x.png" 
          page_title="Asia Region" 
          ...
          {countries.map((f_data, index) => {
            return (
              <>
                <>
                {
                  f_data.region == "Asia" ? <div className={styles.box} id="box" key={index}>
