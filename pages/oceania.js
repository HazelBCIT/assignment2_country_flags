...
export default function Oceania() {
  ...
  return (
    <>
      <Head>
        <title>World Flags - Oceania</title>
        <meta name="description" content="Country flags of Oceania Region" />
      ...
      <main className={styles.main}>
        <Header />
        <Title
          title_img="/oceania@2x.png" 
          page_title="Oceania Region" 
          ...
          {countries.map((f_data, index) => {
            return (
              <>
                <>
                {
                  f_data.region == "Oceania" ? <div className={styles.box} id="box" key={index}>
